package org.mlm.tvbrwser.model
...
import org.mlm.tvbrwser.service.downloads.DownloadTask
import org.mlm.tvbrwser.service.downloads.FileDownloadTask
import org.mlm.tvbrwser.singleton.AppDatabase
import org.mlm.tvbrwser.utils.observable.ObservableList
...
class ActiveDownloadsModel: ActiveModel() {
    ...
    suspend fun deleteItem(download: Download) {
        ...
        AppDatabase.db.downloadsDao().delete(download)
    }
